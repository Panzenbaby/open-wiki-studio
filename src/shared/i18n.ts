...
export const messages: Record<Locale, Dict> = {
  en: {
    ...
    // ── remove from wiki ─────────────────────────────────────
    "remove.action": "Remove from wiki",
    "remove.title": "Remove from wiki?",
    "remove.intro": "{n} concept(s) move to wiki/trash/. Nothing is deleted.",
    "remove.concepts": "Concepts",
    "remove.directories": "These folders lose their last concept and disappear:",
    "remove.incoming": "{n} concept(s) link here. Their links will point into the trash:",
    "remove.noIncoming": "No other concept links here.",
    "remove.confirm": "Remove",
    "remove.cancel": "Cancel",
    "remove.planFailed": "Could not check what would be removed: {detail}",
    "remove.done": "Moved {n} concept(s) to the trash",
    "remove.failed": "Could not remove: {detail}",
    "remove.trashHint": "Removed knowledge (wiki/trash/)",
    ...
    "error.removeFromWiki": "Could not remove from wiki: {detail}",
  ...
  de: {
    ...
    "remove.action": "Aus dem Wiki entfernen",
    "remove.title": "Aus dem Wiki entfernen?",
    "remove.intro": "{n} Konzept(e) wandern nach wiki/trash/. Nichts wird gelöscht.",
    "remove.concepts": "Konzepte",
    "remove.directories": "Diese Ordner verlieren ihr letztes Konzept und verschwinden:",
    "remove.incoming": "{n} Konzept(e) verlinken hierher. Ihre Links zeigen danach in den Papierkorb:",
    "remove.noIncoming": "Kein anderes Konzept verlinkt hierher.",
    "remove.confirm": "Entfernen",
    "remove.cancel": "Abbrechen",
    "remove.planFailed": "Konnte nicht prüfen, was entfernt würde: {detail}",
    "remove.done": "{n} Konzept(e) in den Papierkorb verschoben",
    "remove.failed": "Entfernen fehlgeschlagen: {detail}",
    "remove.trashHint": "Entferntes Wissen (wiki/trash/)",
    ...
    "error.removeFromWiki": "Entfernen aus dem Wiki fehlgeschlagen: {detail}",
