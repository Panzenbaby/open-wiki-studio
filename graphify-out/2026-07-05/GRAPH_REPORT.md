...
## Corpus Check
- 45 files · ~16,856 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 345 nodes · 797 edges · 15 communities (14 shown, 1 thin omitted)
...
Cohesion: 0.14
Nodes (20): ContextMenu(), ContextMenuItem, ContextMenuPosition, ContextMenuProps, BranchProps, CtxPosition, FileTree(), FileTreeProps (+12 more)

### Community 5 - "Chat Message & Concept Links"
Cohesion: 0.22
Nodes (9): MarkdownView(), MarkdownViewProps, MessageProps, isConceptPath(), MdastNode, remarkConceptLinks(), splitLinks(), walk() (+1 more)
...
Cohesion: 0.08
Nodes (52): AppShell(), IngestBar(), IngestBarProps, LlmConfigForm(), Message(), Sidebar(), SidebarProps, getLocale() (+44 more)
